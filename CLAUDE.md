...
- **DeepSeek V4-Pro** [VERIFIED] — refresh-check the existing `review/deepseek-v4.html` (AI Coding, 8.1) IF V4-Pro is a genuinely new release; refresh in place if so, otherwise no-op.
