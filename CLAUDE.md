...
- **review/notion-ai.html pricing refresh** — follow-up flagged June 19, 2026 during the Notion AI pricing *blog* refresh. The REVIEW page is now stale: it still describes the retired $10/user/mo standalone add-on and the old Plus-includes-AI model (confirmed stale at lines ~209 and ~267–275). Current reality (verified at notion.com/pricing June 2026): no standalone add-on for new users; full Notion AI is Business ($20/seat annual, $24 monthly) + Enterprise only; Free/Plus = limited AI trial; Custom Agents bill via Notion Credits ($10/1,000, pooled monthly, no rollover, Business/Enterprise only). Deliberately NOT refreshed in the blog pass — refresh the review page in its own pass and sync to the blog post (`blog/notion-ai-pricing-2026.html`).
