...
- **review/windsurf.html refresh for the Devin Desktop rebrand** — OPEN (NEW, June 24, 2026). The review is now factually stale at the NAME level: Windsurf = Devin Desktop (Cognition, June 2, 2026). Refresh needs: rebrand up top, ACP/Agent Command Center/Devin Local direction, Cascade EOL July 1 2026, ownership backstory, current pricing (Free/Pro $20/Max $200/Teams $80+$40), and a score re-check (current 8.2 predates the transition). Keep URL/slug/byline. Out of scope for the June 24 comparison re-eval (deliberately deferred). While in there, **sweep the AI Coding cluster for other stale "Windsurf" references** (category/coding.html card copy still says "Cascade — beginner-friendly IDE" + url windsurf.com; compare.html + reviews.html card copy; cursor-pricing-2026 + best-ai-coding-agents-2026 + claude-code-vs-cursor-vs-github-copilot posts; nav.js label) — update name/framing where current reality is misstated.
